...
DROP TABLE IF EXISTS build_slots;
...
CREATE TABLE components (
    ...
    scoped_number INTEGER NOT NULL,
    name VARCHAR(255) NOT NULL,
    description TEXT,
...
-- +goose Down
DROP INDEX IF EXISTS idx_build_slots_component;
DROP INDEX IF EXISTS idx_builds_creator;
DROP INDEX IF EXISTS idx_builds_template;
