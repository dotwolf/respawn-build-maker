...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/templates/{template_id}/builds": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Build creation data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BuildCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/templates/{template_id}/builds/{build_id}": {
            "get": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.PrivateProfileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
